...
export const RecipeDetail: React.FC = () => {
  ...
  return (
    <div className="h-full min-h-0 bg-background flex flex-col overflow-hidden">
      <div className="flex-1 min-h-0 overflow-y-auto scroll-touch overscroll-none">
        {/* Header */}
      ...
      {/* CTA */}
      <div className="shrink-0 bg-gradient-to-t from-background via-background to-transparent px-6 pt-6 pb-safe-offset-3">
