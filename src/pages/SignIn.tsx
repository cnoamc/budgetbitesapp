          ...
          {view === 'options' && (
            <div className="space-y-3 animate-fade-in">
              ...
              <Button
                ...
                variant="outline"
                className="w-full h-14 rounded-2xl text-base font-medium bg-white/70 backdrop-blur-sm border-border/50 hover:bg-white/90 transition-all text-gray-900"
              >
                <Phone className="w-5 h-5 ml-3 text-gray-700" />
                המשך עם מספר טלפון
              </Button>
