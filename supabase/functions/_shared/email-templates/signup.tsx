...
export const SignupEmail = ({
  ...
  <Html lang="he" dir="rtl">
    <Head />
    <Preview>ברוכים הבאים לשפי! 🎉 אשרו את המייל שלכם</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        />
        <Heading style={h1}>היי, ברוכים הבאים! 👋</Heading>
        <Text style={text}>
          שמחים שהצטרפתם לשפי – העוזר האישי שלכם לבישול חכם וחסכוני.
        </Text>
        <Text style={text}>
          כדי להתחיל, אשרו את כתובת המייל שלכם:
        </Text>
        <Button style={button} href={confirmationUrl}>
          אישור המייל שלי ✅
        </Button>
        <Text style={footer}>
          לא נרשמתם? אפשר להתעלם מהמייל הזה בשקט.
        </Text>
      </Container>
    </Body>
  </Html>
