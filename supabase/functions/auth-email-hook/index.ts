...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'ברוכים הבאים לשפי! אשרו את המייל שלכם ✅',
  invite: 'הוזמנתם להצטרף לשפי! 🍳',
  magiclink: 'קישור התחברות לשפי ✨',
  recovery: 'איפוס סיסמה לשפי 🔑',
  email_change: 'אישור שינוי כתובת מייל בשפי 📧',
  reauthentication: 'קוד האימות שלכם לשפי 🔐',
}
...
// Configuration
const SITE_NAME = "budgetbitesapp"
const SENDER_DOMAIN = "notify.budgetbites.online"
const ROOT_DOMAIN = "budgetbites.online"
const FROM_DOMAIN = "notify.budgetbites.online" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://budgetbitesapp.lovable.app"
